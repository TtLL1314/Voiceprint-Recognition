...
# add_arg('audio_duration',   float,  10,                        '预测的音频长度，单位秒')
...
def load_audio_db(audio_db_path):
    ...
    for audio in audios:
        ...
        print("feature: ", feature, "  TYPE: ", type(feature))

        print("person_name: ", person_name, "  TYPE: ", type(person_name))
        print("person_feature: ", person_feature, "  TYPE: ", type(person_feature))'''
